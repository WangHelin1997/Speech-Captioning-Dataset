...
if __name__ == "__main__":
    ...
    if "speech_duration" in snr_dataset[next(iter(snr_dataset.features.keys()))]:    
    ...
    dataset = dataset.add_column("speaking_rate_value", rate_dataset["speaking_rate"]).add_column("phonemes", rate_dataset["phonemes"])
    if args.apply_squim_quality_estimation:
